      ...
      <div className="product-page-div">
        <div className="container">
          ...
          <div className="specifications">
            <div className="spec">
              <p className="spec-title">Overview:</p>
              <p className="title-desc">{item[0].overview}</p>
            </div>
            <div className="spec">
              <p className="spec-title">Material & Care:</p>
              <p className="title-desc">{item[0].material}</p>
            </div>
            <div className="spec">
              <p className="spec-title">Country and Origin:</p>
              <p className="title-desc">{item[0].origin}</p>
            </div>
          </div>
        </div>
        <TrendingSlider />
